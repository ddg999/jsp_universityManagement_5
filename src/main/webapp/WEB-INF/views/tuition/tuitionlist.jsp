...
<link rel="stylesheet" href="../../resouces/css/student.css">

<style>
.list--table thead tr th, .list--table tbody tr td:nth-of-type(1), .list--table tbody tr td:nth-of-type(2), .list--table tbody tr td:nth-of-type(3) {
	text-align: center;
}
	...
	<div class="sub--menu">
		...
		<div class="sub--menu--mid">
			<table class="sub--menu--table" border="1">
				...
				<tr>
					<td><a href="${pageContext.request.contextPath}/tuition/list" class="selected--menu">등록금 납부 내역</a></td>
				</tr>
			</table>
		</div>
	</div>
