		...
		<form action="/user/professor" method="post">
			<table class="table--container">
				...
				<tr>
					...
					<td style="padding-top: 7px"><label for="male">남성</label> <input type="radio" name="gender" value="남성" id="male" checked="checked"> &nbsp; <label for="female">여성</label>
				...
				<tr>
					...
					<td><input type="text" name="deptId" id="deptId" class="input--box" required></td>
				</tr>
			</table>
