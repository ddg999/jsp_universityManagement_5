...
<div class="d-flex justify-content-center align-items-start" style="min-width: 100em;">
	...
	<main>
		...
		<div class="select--button">
			<a href="/admin/tuition?crud=insert" class="button">등록</a> <a href="/admin/tuition?crud=update" class="button">수정</a> <a href="/admin/tuition?crud=delete" class="button">삭제</a>
		</div>
		...
		<c:if test="${crud.equals(\"insert\")}">
			<form action="/admin/tuition" method="post" class="form--container">
				<div class="insert--form">
					...
					</select> <input type="text" id="name" class="input--box" name="amount" placeholder="등록금을 입력해주세요"> <input type="submit" value="입력">
				</div>
			</form>
