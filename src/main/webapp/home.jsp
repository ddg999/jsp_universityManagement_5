...
>>>>>>> 089dda03a9492baf0951ed1c5b4e36f33d7f27c0
						...
						<c:choose>
							<c:when test="${principal.getUserRole().equals(\"student\")}">
								...
								<div class="profile--button--div">
									<a href="${pageContext.request.contextPath}/info/student"><button>마이페이지</button></a> <a href="${pageContext.request.contextPath}/logout"><button>로그아웃</button></a>
								</div>
							</c:when>
							<c:when test="${principal.getUserRole().equals(\"staff\")}">
								...
								<div class="profile--button--div">
									<a href="${pageContext.request.contextPath}/info/staff"><button>마이페이지</button></a> <a href="${pageContext.request.contextPath}/logout"><button>로그아웃</button></a>
								</div>
							</c:when>
							<c:otherwise>
								<table>
								...
								<div class="profile--button--div">
									<a href="${pageContext.request.contextPath}/info/professor"><button>마이페이지</button></a> <a href="${pageContext.request.contextPath}/logout"><button>로그아웃</button></a>
								</div>
							</c:otherwise>
						</c:choose>
					</div>
